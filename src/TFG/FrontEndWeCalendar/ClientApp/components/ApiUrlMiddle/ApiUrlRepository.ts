...
export module ApiUrlRepository {
    ...
    export var estaBaneado = "estaBaneado";
    export var editarCorreo = "editarGrupo";
    ...
    urls[estaBaneado] = baseUrl + "/Users/estaBaneado";
    urls[editarCorreo] = baseUrl + "/Users/editarCorreo";
